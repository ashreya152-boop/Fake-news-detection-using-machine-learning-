...
In today's digital era, the rapid spread of misinformation through social media and online platforms has become a major challenge. This project aims to automatically analyze news content and classify it as **Fake News** or **Real News** using machine learning algorithms.
...
1. **Dataset Collection**
   ...
   * The dataset contains real and fake news articles used for training and testing.

2. **Data Preprocessing**

   * Removed unwanted characters, punctuation, and stopwords.
   * Converted text into a clean format for analysis.

3. **Feature Extraction**

   * Text data was converted into numerical features using **TF-IDF Vectorization**.
   * Important words and patterns were extracted from news articles.

4. **Model Training**

   * Machine Learning algorithms were applied for classification.
   * A model was trained to learn the difference between fake and real news.
...
* Fake and real news distribution was analyzed.
